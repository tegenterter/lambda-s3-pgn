...
Running the sandbox image exposes the emulated Lambda environment on the endpoint http://localhost:9000/2015-03-31/functions/function/invocations waiting for [S3 event messages](https://docs.aws.amazon.com/AmazonS3/latest/userguide/notification-content-structure.html).
```
make run-sandbox
```
